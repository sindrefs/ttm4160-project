...
def PerformContinousMove(angle=0, direction="FORWARDS"):
    directionPolarity = 1
    ...
    if angle > 0:  # turn right
        ...
        TB.SetMotor2(directionPolarity * -(maxPower * offset) * (1+(angle/100)))
    elif angle < 0:
        TB.SetMotor1(directionPolarity * maxPower * (1+(angle/100)))
